...
import 'package:is201_prj_store_management/screens/khuyenmai/khuyenmai_controller.dart';
import 'package:is201_prj_store_management/screens/khuyenmai/add/khuyenmai_add_screen.dart';
import 'package:is201_prj_store_management/screens/khuyenmai/edit/khuyenmai_edit_screen.dart';
import 'package:is201_prj_store_management/screens/khuyenmai/delete/khuyenmai_delete_screen.dart';
...
class _KhuyenMaiScreenState extends State<KhuyenMaiScreen> {
  final controller = Get.put(KhuyenMaiController());
  String? idSelected;
  int selectedIndex = -1;
            ...
            child: Row(
              children: [
                ...
                IconButton(
                  ...
                  tooltip: 'Thêm',                  onPressed: () async {
                    await showDialog<Map<String, dynamic>>(
                      context: context,
                      builder: (_) => KhuyenMaiAddScreen(),
                    );
                  },
                ),
                IconButton(
                  ...
                  onPressed: () async {
                    if (idSelected != null) {
                      await showDialog(
                        context: context,
                        builder: (_) => KhuyenMaiEditScreen(idKhuyenMai: idSelected!),
                      );
                    }
                  },
                ),
                IconButton(
                  ...
                  onPressed: () {
                    if (idSelected != null) {
                      showDialog(
                        context: context,
                        builder: (_) => KhuyenMaiDeleteScreen(idKhuyenMai: idSelected!),
                      );
                    }
                  },
                ),
